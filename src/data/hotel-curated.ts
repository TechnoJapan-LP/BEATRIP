...
export type CuratedHotel = {
  ...
  // 商用利用可能な画像 URL (Unsplash / Wikimedia Commons 等)。未設定時は tier グラデーション fallback。
  imageUrl?: string;
};
...
export const CURATED_HOTELS: Record<string, CuratedHotel[]> = {
  tokyo: [
    { name: "Park Hyatt Tokyo", area: "新宿", tier: "ラグジュアリー", highlight: "新宿摩天楼一望・映画ロケ地で有名",
      ...
      imageUrl: "https://images.unsplash.com/photo-1540959733332-eab4deabeeaf?w=600&q=80&auto=format&fit=crop&crop=entropy" },
    { name: "Mandarin Oriental Tokyo", area: "日本橋", tier: "ラグジュアリー", highlight: "ミシュラン星付きレストランを多数擁する高層階ホテル",
      ...
      imageUrl: "https://images.unsplash.com/photo-1542051841857-5f90071e7989?w=600&q=80&auto=format&fit=crop&crop=entropy" },
    { name: "Andaz Tokyo", area: "虎ノ門", tier: "ハイクラス", highlight: "虎ノ門ヒルズ最上層・モダンデザイン",
      ...
      imageUrl: "https://images.unsplash.com/photo-1513407030348-c983a97b98d8?w=600&q=80&auto=format&fit=crop&crop=entropy" },
  ...
  osaka: [
    { name: "Conrad Osaka", area: "中之島", tier: "ラグジュアリー", highlight: "高層40Fからの大阪パノラマ・ビジネス利用も",
      ...
      imageUrl: "https://images.unsplash.com/photo-1590559899731-a382839e5549?w=600&q=80&auto=format&fit=crop&crop=entropy" },
  ...
  sapporo: [
    { name: "JR Tower Hotel Nikko Sapporo", area: "札幌駅", tier: "ラグジュアリー", highlight: "JR札幌駅直結・最上階展望大浴場",
      ...
      imageUrl: "https://images.unsplash.com/photo-1542640244-7e672d6cef4e?w=600&q=80&auto=format&fit=crop&crop=entropy" },
  ...
  fukuoka: [
    { name: "The Ritz-Carlton, Fukuoka", area: "天神", tier: "ラグジュアリー", highlight: "天神中心・福岡最高峰のサービス",
      ...
      imageUrl: "https://images.unsplash.com/photo-1528360983277-13d401cdc186?w=600&q=80&auto=format&fit=crop&crop=entropy" },
  ...
  okinawa: [
    { name: "The Busena Terrace", area: "名護", tier: "ラグジュアリー", highlight: "沖縄屈指のラグジュアリーリゾート・部瀬名岬の絶景",
      ...
      imageUrl: "https://images.unsplash.com/photo-1518621736915-f3b1c41bfd00?w=600&q=80&auto=format&fit=crop&crop=entropy" },
    ...
    { name: "Halekulani Okinawa", area: "恩納村", tier: "ラグジュアリー", highlight: "ハワイ発祥ブランド・プライベートビーチ",
      ...
      imageUrl: "https://images.unsplash.com/photo-1505228395891-9a51e7e86bf6?w=600&q=80&auto=format&fit=crop&crop=entropy" },
  ...
  nagoya: [
    { name: "Nagoya Marriott Associa Hotel", area: "名古屋駅", tier: "ラグジュアリー", highlight: "JR名古屋駅直結・JRセントラルタワーズ最上層",
      ...
      imageUrl: "https://images.unsplash.com/photo-1493997181344-712f2f19d87a?w=600&q=80&auto=format&fit=crop&crop=entropy" },
  ...
  bangkok: [
    { name: "Mandarin Oriental Bangkok", area: "リバーサイド", tier: "ラグジュアリー", highlight: "世界的名門・チャオプラヤー川沿いの歴史あるホテル",
      ...
      imageUrl: "https://images.unsplash.com/photo-1508009603885-50cf7c579365?w=600&q=80&auto=format&fit=crop&crop=entropy" },
  ...
  seoul: [
    { name: "Signiel Seoul", area: "蚕室", tier: "ラグジュアリー", highlight: "ロッテワールドタワー76-101F・韓国最高峰",
      ...
      imageUrl: "https://images.unsplash.com/photo-1538485399081-7191377e8241?w=600&q=80&auto=format&fit=crop&crop=entropy" },
  ...
  taipei: [
    { name: "Mandarin Oriental Taipei", area: "中山", tier: "ラグジュアリー", highlight: "屋外プール・ミシュラン星付きレストラン",
      ...
      imageUrl: "https://images.unsplash.com/photo-1470004914212-05527e49370b?w=600&q=80&auto=format&fit=crop&crop=entropy" },
  ...
  singapore: [
    { name: "Marina Bay Sands", area: "マリーナベイ", tier: "ラグジュアリー", highlight: "屋上インフィニティプール・シンガポールの象徴",
      ...
      imageUrl: "https://images.unsplash.com/photo-1525625293386-3f8f99389edd?w=600&q=80&auto=format&fit=crop&crop=entropy" },
  ...
  "hong-kong": [
    { name: "The Peninsula Hong Kong", area: "尖沙咀", tier: "ラグジュアリー", highlight: "アジアを代表する名門・ロールスロイス送迎",
      ...
      imageUrl: "https://images.unsplash.com/photo-1506146332389-18140dc7b2fb?w=600&q=80&auto=format&fit=crop&crop=entropy" },
    { name: "Mandarin Oriental Hong Kong", area: "中環", tier: "ラグジュアリー", highlight: "中環ビジネスエリア中心",
      ...
      imageUrl: "https://images.unsplash.com/photo-1536599018102-9f803c140fc1?w=600&q=80&auto=format&fit=crop&crop=entropy" },
  ...
  hanoi: [
    { name: "Sofitel Legend Metropole Hanoi", area: "旧市街", tier: "ラグジュアリー", highlight: "ハノイ最高峰の歴史的名門・1901年開業",
      ...
      imageUrl: "https://images.unsplash.com/photo-1509030450996-dd1a26dda07a?w=600&q=80&auto=format&fit=crop&crop=entropy" },
  ...
  "ho-chi-minh-city": [
    { name: "The Reverie Saigon", area: "1区", tier: "ラグジュアリー", highlight: "イタリアンデザインのオペラハウス徒歩圏",
      ...
      imageUrl: "https://images.unsplash.com/photo-1583417319070-4a69db38a482?w=600&q=80&auto=format&fit=crop&crop=entropy" },
  ...
  shanghai: [
    { name: "The Peninsula Shanghai", area: "外灘", tier: "ラグジュアリー", highlight: "外灘北端・浦東の夜景一望",
      ...
      imageUrl: "https://images.unsplash.com/photo-1545893835-abaa50cbe628?w=600&q=80&auto=format&fit=crop&crop=entropy" },
  ...
  paris: [
    { name: "The Ritz Paris", area: "ヴァンドーム広場", tier: "ラグジュアリー", highlight: "1898年開業・パリ最高峰の名門",
      ...
      imageUrl: "https://images.unsplash.com/photo-1502602898657-3e91760cbb34?w=600&q=80&auto=format&fit=crop&crop=entropy" },
  ...
  london: [
    { name: "The Savoy", area: "コヴェントガーデン", tier: "ラグジュアリー", highlight: "テムズ川沿い・1889年開業の名門",
      ...
      imageUrl: "https://images.unsplash.com/photo-1513635269975-59663e0ac1ad?w=600&q=80&auto=format&fit=crop&crop=entropy" },
  ...
  helsinki: [
    { name: "Hotel Kämp", area: "中心部", tier: "ラグジュアリー", highlight: "ヘルシンキ最高峰・1887年開業",
      ...
      imageUrl: "https://images.unsplash.com/photo-1538332576228-eb5b4c4de6f5?w=600&q=80&auto=format&fit=crop&crop=entropy" },
  ...
  rome: [
    { name: "Hotel de Russie", area: "スペイン階段", tier: "ラグジュアリー", highlight: "ピンチョの丘・セレブリティに愛される",
      ...
      imageUrl: "https://images.unsplash.com/photo-1552832230-c0197dd311b5?w=600&q=80&auto=format&fit=crop&crop=entropy" },
  ...
  barcelona: [
    { name: "Hotel Arts Barcelona", area: "ベイ", tier: "ラグジュアリー", highlight: "海沿い高層・サグラダファミリア見える",
      ...
      imageUrl: "https://images.unsplash.com/photo-1583422409516-2895a77efded?w=600&q=80&auto=format&fit=crop&crop=entropy" },
  ...
  "new-york": [
    { name: "The Plaza", area: "5番街", tier: "ラグジュアリー", highlight: "セントラルパーク前・映画の舞台",
      ...
      imageUrl: "https://images.unsplash.com/photo-1496442226666-8d4d0e62e6e9?w=600&q=80&auto=format&fit=crop&crop=entropy" },
  ...
  "los-angeles": [
    { name: "The Beverly Hills Hotel", area: "ビバリーヒルズ", tier: "ラグジュアリー", highlight: "ピンクパレスの愛称・セレブリティ御用達",
      ...
      imageUrl: "https://images.unsplash.com/photo-1444723121867-7a241cacace9?w=600&q=80&auto=format&fit=crop&crop=entropy" },
  ...
  honolulu: [
    { name: "Halekulani", area: "ワイキキ", tier: "ラグジュアリー", highlight: "ハワイ最高峰の老舗・「天国にふさわしい館」の名",
      ...
      imageUrl: "https://images.unsplash.com/photo-1542259009477-d625272157b7?w=600&q=80&auto=format&fit=crop&crop=entropy" },
  ...
  dubai: [
    { name: "Burj Al Arab Jumeirah", area: "ジュメイラ", tier: "ラグジュアリー", highlight: "7つ星の称号・ドバイのシンボル",
      ...
      imageUrl: "https://images.unsplash.com/photo-1512453979798-5ea266f8880c?w=600&q=80&auto=format&fit=crop&crop=entropy" },
  ...
  sydney: [
    { name: "Park Hyatt Sydney", area: "ザ・ロックス", tier: "ラグジュアリー", highlight: "オペラハウス正面の絶景",
      ...
      imageUrl: "https://images.unsplash.com/photo-1506973035872-a4ec16b8e8d9?w=600&q=80&auto=format&fit=crop&crop=entropy" },
  ...
  auckland: [
    { name: "Hotel Britomart", area: "ブリトマート", tier: "ラグジュアリー", highlight: "5つ星エコホテル・港エリア",
      ...
      imageUrl: "https://images.unsplash.com/photo-1507699622108-4be3abd695ad?w=600&q=80&auto=format&fit=crop&crop=entropy" },
