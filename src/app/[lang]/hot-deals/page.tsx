...
const FAQS = [
  ...
  {
    q: "どうやって検出しているのですか？",
    a: "日本発の主要路線の最安運賃を6時間ごとに観測し、直前の観測価格から25%以上（かつ3,000円以上）下落した運賃を「超お買い得」として自動検出しています。エコノミーに加え、羽田・成田発 国際線のビジネスクラスも監視対象です。",
  },
  {
    q: "掲載価格で必ず予約できますか？",
  ...
  },
  {
    ...
    a: "あります。ビジネスクラスは元の価格が高いぶん、設定ミスや在庫調整による下落幅が大きく、過去には往復エコノミー並みの価格が出た例も知られています。BEATRIPでは羽田・成田発 国際線のビジネスクラス最安値を専用にウォッチしています。",
  },
];
      ...
      >
        ...
        <section className="mb-8">
          ...
          <p className="mt-2 max-w-3xl text-sm leading-relaxed text-zinc-500 dark:text-zinc-400">
            ...
            して掲載します。エコノミーに加え、羽田・成田発のビジネスクラスも監視対象。
          ...
          <div className="grid grid-cols-1 gap-4 sm:grid-cols-3">
            <div className="rounded-xl border border-zinc-100 bg-white p-5 dark:border-zinc-800 dark:bg-zinc-900">
              ...
              <p className="text-xs leading-relaxed text-zinc-500 dark:text-zinc-400">
                日本の主要7空港発の最安運賃と、羽田・成田発 国際線ビジネスクラスの最安値を継続的に記録します。
              </p>
            </div>
            <div className="rounded-xl border border-zinc-100 bg-white p-5 dark:border-zinc-800 dark:bg-zinc-900">
              ...
              <p className="text-xs leading-relaxed text-zinc-500 dark:text-zinc-400">
                直前の観測から25%以上 (かつ3,000円以上) 下がった運賃だけを「超お買い得」として検出。通常のセール情報とは別軸の掘り出し物です。
              </p>
            </div>
            <div className="rounded-xl border border-zinc-100 bg-white p-5 dark:border-zinc-800 dark:bg-zinc-900">
