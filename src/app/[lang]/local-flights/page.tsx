...
const FAQS = [
  ...
  {
    q: "地方→地方の直行便はある？",
    a: "あります。代表的なのは仙台-福岡 (ANA/JAL/Peach)、新千歳-那覇 (Peach/AIRDO)、福岡-那覇 (ANA/JAL/Peach/SNA)、新千歳-福岡 (ANA/JAL/Peach/Jetstar) など。ただし地方間の便は本数が限られ、季節運航や週数便のみの路線もあります。直行便がない場合は羽田・伊丹・福岡・新千歳・那覇のいずれかでの乗継が一般的です。",
  },
  {
    q: "地方発の LCC は信頼できる？",
