        ...
        <section className="mb-10 grid grid-cols-1 gap-3 sm:gap-4 lg:grid-cols-2">
          ...
          {relatedFlights[0] ? (
            <Link
              ...
              className="group flex items-center gap-3 rounded-2xl bg-gradient-to-br from-rose-500 to-rose-600 px-4 py-4 text-white shadow-lg shadow-rose-500/20 sm:gap-4 sm:px-5 sm:py-5 transition-[box-shadow,transform] hover:-translate-y-0.5 hover:shadow-xl active:scale-[0.99]"
            >
            ...
            <Link
              href="/"
              className="group flex items-center gap-3 rounded-2xl bg-gradient-to-br from-zinc-700 to-zinc-800 px-4 py-4 text-white shadow-lg sm:gap-4 sm:px-5 sm:py-5 transition-[box-shadow,transform] hover:-translate-y-0.5 hover:shadow-xl"
            >
          ...
          <a
            ...
            className="group flex items-center gap-3 rounded-2xl bg-gradient-to-br from-zinc-900 to-zinc-800 dark:from-zinc-100 dark:to-zinc-200 px-4 py-4 text-white dark:text-zinc-900 shadow-lg sm:gap-4 sm:px-5 sm:py-5 transition-[box-shadow,transform] hover:-translate-y-0.5 hover:shadow-xl active:scale-[0.99]"
          >
